...
function switchProduct(currentUser) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (chosenProduct) {
            return +chosenProduct.label; //label = ID
        }
        else {
            return -3;
        }
...
exports.switchProduct = switchProduct;
function getProducts(currentUser) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        var data = yield graphql_request_1.request('http://localhost:8080/graphql?', query, variables);
        for (var i = 0; i < data.products.length; i++) {
            products.push({
                label: String(data.products[i].id),
                detail: data.products[i].name
            });
        }
        return products;
    });
...
function createProduct(currentUser) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (productName) {
            var productData = yield graphql_request_1.request('http://localhost:8080/graphql?', productQuery, productVariables);
        }
        ...
        if (productData.productCreate.id) {
            var taskData = yield graphql_request_1.request('http://localhost:8080/graphql?', taskQuery, taskVariables);
        }
        ...
        if (taskData.taskCreate.id) {
            var sessionData = yield graphql_request_1.request('http://localhost:8080/graphql?', sessionQuery, sessionVariables);
        }
        if (productData.productCreate.id) {
